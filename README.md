...
The API was developed to learn how configure Authentication and Authorization in Spring application using Spring Security.
...
```bash
git clone https://github.com/vinicius-ssantos/auth-api-testing.git
```
